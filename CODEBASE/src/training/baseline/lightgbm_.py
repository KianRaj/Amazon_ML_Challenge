...
# NOTE: To use 'device':'gpu', you need a GPU-enabled build of LightGBM.
model = Pipeline([
...
# Train the model
print("Training LightGBM model on combined features (GPU)...")
...
plt.title('Actual vs Predicted Price (Combined Features)')
plt.show()

# Save the model
joblib.dump(model, 'lightgbm_combined_gpu_model.pkl')
print("Model saved as lightgbm_combined_gpu_model.pkl")